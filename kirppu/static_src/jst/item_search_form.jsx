    ...
    return (
        <form role="form" className="form-horizontal item-search-form">
            ...
            <div className="form-group">
                <label htmlFor="item_search_input" className="control-label col-sm-3">{gettext("Name / Bar code")}</label>
            ...
            <div className="form-group">
                <label htmlFor="item_code_search_input"
                       className="control-label col-sm-3">{gettext("Bar code part")}</label>
                <div className="input-group col-sm-9">
            ...
            <div className="form-group">
                <label htmlFor="vendor_search_input" className="control-label col-sm-3">{gettext("Vendor ID")}</label>
                <div className="input-group col-sm-2">
            ...
            <div className="form-group form-inline">
                <label htmlFor="item_search_min_price"
                       className="control-label col-sm-3">{gettext("Price")}</label>
            ...
            <div className="form-group">
                <label htmlFor="item_search_type" className="control-label col-sm-3">{gettext("Type")}</label>
                <div className="input-group col-sm-9">
            ...
            <div className="form-group">
                <label htmlFor="item_search_state" className="control-label col-sm-3">{gettext("State")}</label>
                <div className="input-group col-sm-9">
            ...
            <div className="form-group">
                <label className="control-label col-sm-3">{gettext("Is a box?")}</label>
                <label className="radio-inline">
                    <input type="radio" id="show_box_na" defaultChecked="defaultChecked" name="is_box" value="" checked="checked"/>{gettext("Don't care")}
                </label>
                <label className="radio-inline">
            ...
            <div className="form-group">
                <div className="input-group col-sm-offset-3 col-sm-9">
