...
event_urls = [
    ...
    path("accounting/cleanup/check", balance_export.check_cleanup, name="balance_check_cleanup"),
    path("accounting/cleanup/do", balance_export.do_cleanup, name="balance_details_cleanup"),
